...
const PrintableComponent = forwardRef((props, ref) => {
  return (
    <div ref={ref} className="flex h-screen w-full items-center justify-center bg-gray-600">
      <div className="w-80 rounded bg-gray-50 px-6 pt-8 shadow-lg">
        <img src="logo.png" alt="Tailwind CSS Logo" className="mx-auto w-16 py-4" />
        <div className="flex flex-col justify-center items-center gap-2">
          <h4 className="font-semibold">Hotel Rajshahi Inn</h4>
          <p className="text-xs">188/3, Uposhohor, Boalia, Rajshahi.</p>
        </div>
